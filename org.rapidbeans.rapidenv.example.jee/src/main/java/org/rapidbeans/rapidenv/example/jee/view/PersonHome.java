package org.rapidbeans.rapidenv.example.jee.view;
...
import org.rapidbeans.rapidenv.example.jee.bean.SchoolDao;
...
public class PersonHome extends EntityHome<Person> implements Serializable {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.rapidbeans.rapidenv.example.jee.view.EntityHome#doInit()
	 */
	@Override
