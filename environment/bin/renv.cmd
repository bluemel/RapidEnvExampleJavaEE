...
if defined HTTP_NON_PROXY_HOSTS set RAPID_ENV_COMMAND=%RAPID_ENV_COMMAND% "-Dhttp.nonProxyHosts=%HTTP_NON_PROXY_HOSTS%"
set RAPID_ENV_COMMAND=%RAPID_ENV_COMMAND% -classpath "%RAPID_ENV_HOME%\lib\rapidenv-1.3.0.jar
