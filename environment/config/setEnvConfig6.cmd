...
copy "%RENVEXAMPLEJAVAEE_HOME%\jeesandboxexample\project_6.xml" "%RENVEXAMPLEJAVAEE_HOME%\jeesandboxexample\.project"
copy "%RENVEXAMPLEJAVAEE_HOME%\jeesandboxexample\classpath_6.xml" "%RENVEXAMPLEJAVAEE_HOME%\jeesandboxexample\.classpath"
